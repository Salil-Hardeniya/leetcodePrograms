...
public class MinTimeToReach3341 {
    public static void main(String[] args) {
        MinTimeToReach3341 minTimeToReach3341 = new MinTimeToReach3341();
        int[][] array = {{0,4},{4,4}};
        int ans = minTimeToReach3341.minTimeToReach(array);
        ...
        while (!pq.isEmpty()){
            ...
            for(int[] d : dir){
                ...
                if (moveTime[x][y] <= currentTime) {
                    ...
                    newTime = moveTime[x][y] + 1;
                }
                if(newTime < time[x][y]){
                    time[x][y] = newTime;
                    pq.add(new int[]{x,y,newTime});
                }
            }
        }
